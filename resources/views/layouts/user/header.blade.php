        ...
        <div class="container mx-auto h-full">
            <div class="flex flex-col h-full justify-center items-center sm:justify-between sm:flex-row">
                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="flex items-center justify-center grow my-4 sm:mt-0 font-main">
                        <a href="{{route('home')}}" title="{{__('site.main_page')}}" class="flex flex-col items-center uppercase text-xs font-semibold mr-2 {{Route::currentRouteName()==='home'?'text-amber-700':'text-amber-600'}}">
                        ...
                        <a href="{{route('exhibits')}}" title="{{__('site.exhibits')}}" class="flex flex-col items-center uppercase text-xs font-semibold mr-2 {{Route::currentRouteName()==='exhibits'?'text-amber-700':'text-amber-600'}}">
                        ...
                        <a href="#" title="{{__('site.archive')}}" class="flex flex-col items-center uppercase text-xs font-semibold mr-2 {{Route::currentRouteName()==='archive'?'text-amber-700':'text-amber-600'}}">
