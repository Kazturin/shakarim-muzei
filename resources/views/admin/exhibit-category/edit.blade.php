...
@section('content')
    ...
    >
        ...
        <form action="{{ route('exhibit-categories.update',$exhibitCategory->id) }}" method="POST">
            @csrf
            @method('patch')
            <div class="my-2">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Name"
                        name="title_kz"
                        value="{{$exhibitCategory->title_kz}}"
                    />
                </label>
            </div>
            <div class="my-2">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Name"
                        name="title_ru"
                        value="{{$exhibitCategory->title_ru}}"
                    />
                </label>
            </div>
            <div class="my-2">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Name"
                        name="title_en"
                        value="{{$exhibitCategory->title_en}}"
                    />
                </label>
            </div>
